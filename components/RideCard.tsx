...
const RideCard = ({ ride }: { ride: Ride }) => {
  ...
  const fallbackUrl =
    "https://ucarecdn.com/f42289c0-db87-4185-9ba9-c70da0e309fb/-/preview/1000x1000/";
  const mapImage = process.env.EXPO_PUBLIC_GEOAPIFY_API_KEY
    ...
    <View className="flex flex-row items-center justify-center bg-white rounded-lg shadow-sm shadow-neutral-300 mb-3">
      <View className="flex flex-col items-start justify-center p-3 w-full">
        <View className="flex flex-row items-center justify-between w-full">
          <Image
            source={{
              uri: imageError ? fallbackUrl : mapImage,
            }}
